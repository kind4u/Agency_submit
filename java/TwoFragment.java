...
public class TwoFragment extends Fragment {
    TextView firstMuseumName;
    TextView secondMuseumName;
    TextView thirdMuseumName;
    TextView forthMuseumName;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        firstMuseumName = (TextView) view.findViewById(R.id.firstMuseumName);
        secondMuseumName = (TextView) view.findViewById(R.id.secondMuseumName);
        thirdMuseumName = (TextView) view.findViewById(R.id.thirdMuseumName);
        forthMuseumName = (TextView) view.findViewById(R.id.forthMuseumName);

        new MuseumRankTask().execute();
    ...
    class MuseumRankTask extends AsyncTask<Void, Void, String>
    {
        String target;

        @Override
        protected void onPreExecute() {
            target = "http://1.255.57.7/MuseumRank.php";
        }
        ...
        protected void onPostExecute(String aquaResult) {
            try {
                ...
                firstMuseumName.setText(firstStringName);
                ...
                secondMuseumName.setText(secondStringName);
                ...
                thirdMuseumName.setText(thirdStringName);
                ...
                forthMuseumName.setText(forthStringName);
            }   catch (Exception e) {
                e.printStackTrace();
            }
        }
